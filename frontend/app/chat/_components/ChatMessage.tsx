...
export function ChatMessage({
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
        <div
          className={`max-w-[96%] rounded-2xl px-4 py-3 text-base leading-7 whitespace-pre-wrap break-words shadow-sm sm:max-w-[86%] md:max-w-[74%] lg:max-w-[68%] xl:max-w-[62%] ${
            isUser
